...
| Màn hình Giới thiệu | Màn hình Tải ảnh | Màn hình Khảo sát |
| :---: | :---: | :---: |
| ![Intro Screen](LINK_TO_YOUR_SCREENSHOT) | ![Upload Screen](LINK_TO_YOUR_SCREENSHOT) | ![Survey Screen](LINK_TO_YOUR_SCREENSHOT) |
| **Màn hình Kết quả** | **Màn hình Gợi ý (Tabs)** | **Màn hình Lịch sử & Hồ sơ** |
| ![Results Screen](LINK_TO_YOUR_SCREENSHOT) | ![Suggestions Screen](LINK_TO_YOUR_SCREENSHOT) | ![History & Profile Screen](LINK_TO_YOUR_SCREENSHOT) |
...
* **Email:** nhom@skinai.vn
* **GitHub:** github.com/skinai-team